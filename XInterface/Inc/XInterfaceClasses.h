...
public:
    ...
    BITFIELD bFixedMouseSize:1 GCC_PACK(4);
    BYTE KeyDown[255] GCC_PACK(4);
    TArrayNoInit<class UClass*> RegisteredClasses GCC_PACK(4);
    BITFIELD bECEEdition:1 GCC_PACK(4);
    FScriptDelegate __OnNeedRawKeyPress__Delegate GCC_PACK(4);
    FScriptDelegate __AddBuddy__Delegate;
    DECLARE_FUNCTION(execGetMainMenuClass);
    DECLARE_FUNCTION(execCheckForECE);
    DECLARE_FUNCTION(execAuthroizeFirewall);
    DECLARE_FUNCTION(execCheckFirewall);
    ...
    DECLARE_CLASS(UGUIController,UBaseGUIController,0|CLASS_Transient|CLASS_Config,XInterface)
...
AUTOGENERATE_FUNCTION(UGUIController,-1,execCheckForECE);
AUTOGENERATE_FUNCTION(UGUIController,-1,execAuthroizeFirewall);
AUTOGENERATE_FUNCTION(UGUIController,-1,execCheckFirewall);
...
{ 
	...
	MAP_NATIVE(UGUIController,execCheckForECE)
	MAP_NATIVE(UGUIController,execAuthroizeFirewall)
	MAP_NATIVE(UGUIController,execCheckFirewall)
