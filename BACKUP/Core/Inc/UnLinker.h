...
public:
	...
	INT GetFileVersionComplete() const { return FileVersion; }
	...
	FArchive& operator<<( FName& Name )
	{
		...
		*Loader << AR_INDEX(NameIndex);
		...
		if( !NameMap.IsValidIndex(NameIndex) )
			appErrorf(NAME_FriendlyError, TEXT("Bad name index %i/%i.  This error is probably due to either your computer overheating, or a corrupted installation of your game.  If this error persists, please try re-installing the game."), NameIndex, NameMap.Num() );
