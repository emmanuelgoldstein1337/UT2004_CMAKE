...
//FIXME: Seems declared functions to be inline ///REMOVE = 0 from private: static UClass PrivateStaticClass 
#if !__STATIC_LINK
...
// Register a class at startup time.
	...
	#define IMPLEMENT_CLASS(TClass) \
		...
		DLL_EXPORT UClass* autoclass##TClass = TClass::StaticClass();//TClass::StaticClass() // BUG ALERT ABOVE (&TClass::StaticConstructor), add & in (void(*)(void*))TClass::InternalConstructor
#else
	#define IMPLEMENT_CLASS(TClass) \
		UClass TClass::PrivateStaticClass \
		( \
