...
//
//-----------------------------------------------------------
class ONSBellyTurretFire extends ONSTurretBeamEffect;
...
simulated function PostNetBeginPlay()
{
	...
	PlaySound(Sound'CicadaSnds.BellyLaser.BellyLaserFire', SLOT_None, 5.0,, 300,1, false);
}
...
defaultproperties
{
    Begin Object Class=BeamEmitter Name=BeamEmitter0
        ...
        ColorScale(1)=(RelativeTime=1.000000,Color=(B=0,G=25,R=40))
        MaxParticles=1
