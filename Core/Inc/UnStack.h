 ...
 */
struct CORE_API FScriptCallGraph
{
	/**
	 * Constructor
	 *
	 ...
	 */
	inline void EmitCycles( PTRINT Cycles )
	{
		PTRINT Value = (Cycles & ~3) | 1;
		Data.AddItem( Value );
	}
	 ...
	 */
	inline UBOOL IsFrameEndMarker( PTRINT Value )
	{
		return (Value & 3) == 3;
	}
	 ...
	 */
	inline UBOOL IsEndMarker( PTRINT Value )
	{
		return Value == 0;
	}
...
extern CORE_API FScriptCallGraph* GScriptCallGraph;
