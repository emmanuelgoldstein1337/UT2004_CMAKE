...
public:
	...
	void Seek( INT InPos )
	{
		...
		check(InPos>=0);
		if ( InPos > Size )
			appErrorf(NAME_FriendlyError, TEXT("InPos>Size in FFileManagerAnsi.  This error is probably due to either your computer overheating, or a corrupted installation of your game.  If this error persists, please try re-installing the game."), NameIndex, NameMap.Num() );
