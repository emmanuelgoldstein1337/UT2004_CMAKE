...
void WBrowserLIPSinc::OnCreate()
{
	...
	AnimListLabel->SetText( TEXT(" Impersonator Animations") );
	...
	FString regInfo = FString::Printf(TEXT("This copy of Impersonator is licensed to %s"), appFromAnsi(info));
