...
AUTOGENERATE_NAME(IsVehicleEmpty)
...
AUTOGENERATE_NAME(OnBuildMOTD)
AUTOGENERATE_NAME(OnPostRender)
...
AUTOGENERATE_NAME(UpdateTiltForceFeedback)
...
public:
    ...
    DECLARE_CLASS(UBaseGUIController,UInteraction,0|CLASS_Transient|CLASS_Config,Engine)
...
public:
    ...
    BITFIELD bIsSaveGame:1;
    BITFIELD bLiberalVehiclePaths:1;
    BITFIELD bLargeGameVOIP:1;
...
public:
    ...
    BITFIELD bCanHover:1;
    BITFIELD bCanDoTrickJumps:1;
    ...
    BITFIELD eventVerifyLock(class AActor* Aggressor, class AActor*& NewTarget)
    {
        AVehicle_eventVerifyLock_Parms Parms;
        Parms.ReturnValue=0;
        Parms.Aggressor=Aggressor;
        Parms.NewTarget=NewTarget;
        ProcessEvent(FindFunctionChecked(ENGINE_VerifyLock),&Parms);
        NewTarget=Parms.NewTarget;
        return Parms.ReturnValue;
    }
    BITFIELD eventIsVehicleEmpty()
    {
        AVehicle_eventIsVehicleEmpty_Parms Parms;
        Parms.ReturnValue=0;
        ProcessEvent(FindFunctionChecked(ENGINE_IsVehicleEmpty),&Parms);
        return Parms.ReturnValue;
    }
    ...
    void eventLockOnWarning()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_LockOnWarning),NULL);
    }
    void eventTakeWaterDamage(FLOAT DeltaTime)
    {
        AVehicle_eventTakeWaterDamage_Parms Parms;
        Parms.DeltaTime=DeltaTime;
        ProcessEvent(FindFunctionChecked(ENGINE_TakeWaterDamage),&Parms);
    }
    void eventDrivingStatusChanged()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_DrivingStatusChanged),NULL);
    }
    void eventUpdateTiltForceFeedback()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_UpdateTiltForceFeedback),NULL);
    }
...
public:
    ...
    BITFIELD bNoSuperSize:1;
    BITFIELD bForcedOnly:1;
...
class ENGINE_API AHoverPathNode : public ARoadPathNode
{
public:
    DECLARE_CLASS(AHoverPathNode,ARoadPathNode,0,Engine)
...
public:
    ...
    FLOAT MaxRange;
    class UMaterial* IconFlashMaterial;
...
struct AHUD_eventOnBuildMOTD_Parms
{
    class AHUD* Sender;
};
struct AHUD_eventOnPostRender_Parms
{
    class AHUD* Sender;
    class UCanvas* C;
};
...
public:
    ...
    FScriptDelegate __OnPostRender__Delegate;
    FScriptDelegate __OnBuildMOTD__Delegate;
    ...
    void delegateOnBuildMOTD(class AHUD* Sender)
    {
        AHUD_eventOnBuildMOTD_Parms Parms;
        Parms.Sender=Sender;
        ProcessDelegate(ENGINE_OnBuildMOTD,&__OnBuildMOTD__Delegate,&Parms);
    }
    void delegateOnPostRender(class AHUD* Sender, class UCanvas* C)
    {
        AHUD_eventOnPostRender_Parms Parms;
        Parms.Sender=Sender;
        Parms.C=C;
        ProcessDelegate(ENGINE_OnPostRender,&__OnPostRender__Delegate,&Parms);
    }
...
public:
    ...
    BITFIELD bScriptPostRender:1 GCC_PACK(4);
    void eventPostRender2D(class UCanvas* C, FLOAT ScreenLocX, FLOAT ScreenLocY)
    {
...
{
public:
    FName LIPSincAnimName GCC_PACK(4);
    FLOAT Volume;
    INT Radius;
    FLOAT Pitch;
...
public:
    ...
    DECLARE_CLASS(UManifest,UObject,0|CLASS_Transient,Engine)
    #include "UManifest.h"
};
...
AUTOGENERATE_FUNCTION(ALevelInfo,-1,execGetPhysicsVolume);
...
DECLARE_NATIVE_TYPE(Engine,UAnimNotify_LIPSinc);
...
DECLARE_NATIVE_TYPE(Engine,AHoverPathNode);
...
#define AUTO_INITIALIZE_REGISTRANTS_ENGINE \
	...
	UAnimNotify_LIPSinc::StaticClass(); \
...
{ 
	MAP_NATIVE(UCacheManager,execGetAnnouncerRecord)
	MAP_NATIVE(UCacheManager,execGetVehicleRecord)
	MAP_NATIVE(UCacheManager,execGetWeaponRecord)
	MAP_NATIVE(UCacheManager,execGetMutatorRecord)
...
{ 
	...
	MAP_NATIVE(ALevelInfo,execGetPhysicsVolume)
...
VERIFY_CLASS_SIZE_NODIE(AHoverPathNode)
